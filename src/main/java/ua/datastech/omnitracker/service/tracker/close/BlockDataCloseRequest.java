...
public class BlockDataCloseRequest implements CloseRequest {
    ...
    public void cleanup(OimUserDto oimUserDto) {
        ...
        Integer removedCount = jdbcTemplate.execute("delete from OMNI_BLOCK_DATA where OMNI_BLOCK_REQUEST_ID = :id",
                namedParameters,
    ...
    ***REMOVED***
    ...
    public Set<String> getActions() {
        ...
        actions.add(ActionType.DISABLE_USER.name());
        actions.add(ActionType.ENABLE_USER.name());
        actions.add(ActionType.DISABLE_REGION.name());
        actions.add(ActionType.ENABLE_REGION.name());
        return actions;
    ***REMOVED***
